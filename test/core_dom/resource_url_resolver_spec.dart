...
_run_resolver({useRelativeUrls}) {
  describe("resolveUrls=$useRelativeUrls", () {
    ...
    testOnHtmlTemplate(url, expected, typeOrIncludeUri) {
     it('within an img src attribute', () {
       var html = resourceResolver.resolveHtml(urlInImgSrc(url), typeOrIncludeUri);
       expect(html).toEqual(urlInImgSrc(expected));
     });
    }
